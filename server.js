  ...
  <body style="margin:0; padding:0; background:#f4f7fb; font-family:Arial, sans-serif; color:#1f2937;">
    <div style="width:100%; background:#f4f7fb; padding:24px 12px;">
      <div style="max-width:640px; margin:0 auto; background:#ffffff; border-radius:18px; overflow:hidden; box-shadow:0 8px 24px rgba(15,23,42,0.08); border:1px solid #e5e7eb;">
        ...
        <div style="padding:28px 28px 18px; text-align:center; background:linear-gradient(135deg,#149dff 0%,#00d5ff 100%);">
          <img
            src="cid:icphlogo"
            alt="ICPH Logo"
            style="width:110px; max-width:110px; height:auto; display:block; margin:0 auto 12px; filter:drop-shadow(0 2px 6px rgba(0,0,0,0.20));"
          />

          <div style="font-size:28px; font-weight:800; color:#ffffff; letter-spacing:0.3px;">
            ICPH Uptown Laguna
          </div>
        </div>

        <div style="padding:28px;">
          <div style="display:inline-block; padding:8px 14px; border-radius:999px; background:${titleColor}; color:#ffffff; font-size:13px; font-weight:700; margin-bottom:18px;">
          ...
          <div style="margin-top:28px; padding-top:18px; border-top:1px solid #e5e7eb; font-size:13px; line-height:1.7; color:#6b7280;">
            ${footerText}
          </div>
        </div>
      </div>
